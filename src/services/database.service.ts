...
const uri = `mongodb+srv://${envConfig.dbUsername}:${envConfig.dbPassword}@twitter.ufcaelj.mongodb.net/?retryWrites=true&w=majority`
...
class DatabaseService {
	...
	get conversations(): Collection<Conversation> {
		return this.db.collection(envConfig.dbConversations)
	}
}
